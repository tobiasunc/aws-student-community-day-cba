...
<template>
  <v-dialog v-model="dialog" width="900" persistent>
    <template v-slot:activator="{ props: activatorProps }">
      ...
      >
        <!-- El frame viene de assets; la foto sale de public/img/speakers y tiene fallback en common. -->
        <v-img alt="Marco visual de speaker" class="frame" src="/assets/img/frame.png"></v-img>
        <v-img
          class="avatar"
          aspect-ratio="1"
          cover
